const CODE = {
  ...
  HTTP_API_ACCESS_TOKEN_REFRESH: 2102,
  // http 业务错误 - 用户接口
  HTTP_API_USER_DETAIL: 2201,
  HTTP_API_USER_EDIT_AVATAR: 2202,
  HTTP_API_USER_EDIT_NICKNAME: 2203,
  HTTP_API_USER_EDIT_SLOGAN: 2204,
  // http 业务错误 - TOTP 接口
  HTTP_API_TOTP_ALL: 2300,
  HTTP_API_TOTP_DETAIL: 2301,
  HTTP_API_TOTP_CREATE: 2302,
  HTTP_API_TOTP_EDIT_ISSUER: 2303,
  HTTP_API_TOTP_EDIT_USERNAME: 2304,
  HTTP_API_TOTP_DELETE: 2305,
...
const MESSAGE = {
  ...
  [CODE.HTTP_API_ACCESS_TOKEN_REFRESH]: "刷新令牌失败",
  [CODE.HTTP_API_USER_DETAIL]: "查询详情失败",
  [CODE.HTTP_API_USER_EDIT_AVATAR]: "更新失败",
  [CODE.HTTP_API_USER_EDIT_NICKNAME]: "更新失败",
  [CODE.HTTP_API_USER_EDIT_SLOGAN]: "更新失败",
  [CODE.HTTP_API_TOTP_ALL]: "查询列表失败",
  [CODE.HTTP_API_TOTP_DETAIL]: "查询详情失败",
  [CODE.HTTP_API_TOTP_CREATE]: "新增失败",
  [CODE.HTTP_API_TOTP_EDIT_ISSUER]: "更新失败",
  [CODE.HTTP_API_TOTP_EDIT_USERNAME]: "更新失败",
